...
awk 'NF && !/\[|\]/ && !/#/ {print "nftset=/" $1 "/4#inet#fw4#vpn_domains"}' $SP/mydomains_tp-link.txt $SP/geoblock.txt $SP/meta.txt $SP/tiktok.txt $SP/telegram.txt $SP/hosts-google.txt $SP/youtube.txt $sp/WhatsApp.txt >$DP/domains_tp-link.lst 
#awk 'NF && !/\[|\]/ && !/#/ {print "nftset=/" $1 "/4#inet#fw4#vpn_domains"}' $SP/mydomains_tp-link.txt $SP/geoblock.txt $SP/meta.txt $SP/tiktok.txt $SP/telegram.txt $SP/youtube.txt $sp/WhatsApp.txt >$DP/domains_tp-link.lst 
